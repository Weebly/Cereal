...
*/
public func deepCast<KeyType, ValueType, CastedType>(_ sequence: [[KeyType: ValueType]]) -> [[KeyType: CastedType]] {
    return sequence.map {
...
- returns:      The casted copy
*/
public func deepArrayCast<KeyType, ValueType, CastedType>(_ sequence: [KeyType: [ValueType]]) -> [KeyType: [CastedType]] {
